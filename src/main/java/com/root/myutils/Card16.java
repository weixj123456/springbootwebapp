...
private static String getRandomString(String[] strgroup) {
 ...
 private static String getBankno16() {
		String bin=Card16.getBankbin();
		String applAcNo15 = bin + String.valueOf(tails(100000000, 999999999));
		Card16  card=new Card16(applAcNo15);
		String bankcardno=card.getCard();
		return bankcardno;
	}

	public static String getBankName(String bankname) {
		String no=Card16.getBankno16();
		int num=0;
		while(!Card16.getBankCardName(no).equals(bankname)) {
			num++;
			no=Card16.getBankno16();
//			if(!Card19.getBankCardName(no).equals("建设银行"));
			if(num==100000) {
				if(!Card16.getBankCardName(no).equals(bankname)) {
...
// /*   
    public static void main(String[] args) {
    	String bin=Card16.getBankbin();
    	String applAcNo15 = bin + tails(100000000, 999999999);
    	Card16  card=new Card16(applAcNo15);
    	String bankcardno=card.getCard();
    	System.out.println(bankcardno);
    	Card16.getBankCardName(bankcardno);
